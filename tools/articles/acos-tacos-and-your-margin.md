title:        What ACOS Should You Be Aiming For?
...
- What do ACOS and TACOS actually measure?
- Is there a right ACOS number to aim for?
- How do I work out my own break-even ACOS?
- What does an ACOS above or below my break-even mean in money?
- Should I ever spend above my break-even ACOS?
- Why can a low ACOS still be a bad sign?
- What should TACOS do over time, and when is it a warning?
- Where do these numbers come from, and do they cover the same thing?
...
[[Worked example]]
Selling price | $29.99
Amazon referral fee, 15% in this example's category | $4.50
FBA fulfillment fee, this example's size and weight | $5.60
Landed cost per unit, imported: factory price, freight, duty, inland transport | $7.20
Storage and refund allowance per unit | $0.70
Total cost before advertising | $18.00
Contribution before advertising, $29.99 minus $18.00 | $11.99
Break-even ACOS, $11.99 divided by $29.99 | 39.98%
...
[[Worked example]]
Break-even ACOS | 39.98%
Actual ACOS during the launch month | 70%
Ad-attributed sales that month | $2,000.00
Ad spend, 70% of $2,000.00 | $1,400.00
Contribution those sales generate, 39.98% of $2,000.00 | $799.60
Amount invested that month | $600.40
Organic sales per month once ranking settles | $1,500.00
Contribution from those organic sales | $599.70
Months at that organic level to return the investment | just over 1
...
[[FIGURE: ACOS stays flat while TACOS falls as organic sales grow over six months]]
...
[[Worked example]]
Month 9 — ad spend | $900
Month 9 — ad-attributed sales | $3,000
Month 9 — organic sales | $1,800
Month 9 — total sales | $4,800
Month 9 — ACOS | 30.0%
Month 9 — TACOS | 18.75%
...
Ad spend for the period — Campaign Manager > Spend column — covers ad traffic only, for the campaigns and date range selected — matches the claim: yes

Ad-attributed sales for the period — Campaign Manager > Sales column — covers sales Amazon credits to clicks on the selected ads within the attribution window (Sponsored Products 7 days for sellers; Sponsored Brands and Sponsored Display 14 days), in the selected date range — matches the claim: yes

ACOS as reported — Campaign Manager > ACOS column — computed from the same two ad-traffic-only figures above — matches the claim: yes

Ad reporting is incomplete for recent days and keeps filling in — Campaign Manager, a consequence of the attribution window above — covers ad-attributed sales credited after the click — matches the claim: yes

Total sales for the TACOS denominator, one product — Seller Central > Reports > Business Reports > Detail Page Sales and Traffic by Child Item > Ordered Product Sales column — covers all orders for that child ASIN in the date range, all traffic sources, valued at time of order — matches the claim: yes

Whether Ordered Product Sales is reduced by later returns and refunds — same column as above — covers orders valued at the time of order — matches the claim: uncertain because Amazon's published descriptions state the figure is recorded at order time but do not state whether later refunds are removed from it retroactively. The article claims only that an order later cancelled or refunded was counted on the day it was placed, and that the figure is neither revenue after returns nor a payout. It never claims the figure is net of returns. Confirm against Amazon's current Business Reports help page before shipping.

Whether Campaign Manager's Sales column and Business Reports' Ordered Product Sales treat cancellations identically — Campaign Manager > Sales column against Business Reports > Ordered Product Sales — populations differ: ad-attributed sales within the attribution window versus all orders for the child ASIN — matches the claim: uncertain because published descriptions indicate ad-attributed sales drop payment failures and very early cancellations, and Business Reports' handling of the same events is not stated. The article claims only that both are order-time sales figures rather than payout figures, and never claims the two treat cancellations the same way. Confirm before shipping.

Reader's own referral fee percentage — Amazon's fee estimate tool for their ASIN and price, plus the current fee schedule in Seller Central Help — covers that one ASIN, in that one category, at that one price — matches the claim: yes

Reader's own FBA fulfillment fee — Amazon's fee estimate tool for their ASIN — covers that one ASIN at its measured size tier and weight — matches the claim: yes

Name and location of Amazon's fee estimate tool — Seller Central Help — covers the tool as currently published — matches the claim: yes, CONFIRMED 2026-09-12 against Leon's own live console (screenshot on file). It is titled "Revenue Calculator" and opens by clicking the estimated fee figure against a listing, not from a menu, which is why a menu path could never be confirmed. The panel lists Referral Fee, Fixed Closing Fee, Variable Closing Fee and Digital Services Fee under "Amazon fees", with "Fulfillment cost" shown separately. Superseded background follows. The article names it only as "Revenue Calculator", tells the reader to search Seller Central Help rather than follow a menu path, and makes no claim about its location. Re-check the current name before shipping.

Reader's own landed cost per unit, imported product — not an Amazon figure: supplier invoices, freight forwarder invoice, customs entry documents — covers one production run, per unit — matches the claim: yes

Reader's own refund rate, for the refund allowance line — the reader's own units-refunded and units-ordered records over several months — covers that one SKU over the period measured — matches the claim: yes, but a beginner will not have enough months yet. The article says so, tells the reader to use a cautious allowance meanwhile, and states the direction of the error: omitting refunds raises the apparent break-even ACOS and encourages overspending.

## New terms

- break-even ACOS — the ACOS at which a unit sold through advertising leaves exactly zero profit; nearest everyday English: the advertising cost at which a sale stops being worth making
- contribution before advertising — what is left of the selling price after Amazon's fees and all product costs, before any ad spend; nearest everyday English: what you have available to spend on ads and still profit
- ad-attributed sales — the sales Amazon credits to clicks on your ads within the attribution window; the money counterpart of "ad-attributed order", which Article 1 defines
- attribution window — the period after an ad click during which Amazon still credits a resulting sale to that ad; nearest everyday English: how long a click keeps counting
- organic sales — sales Amazon does not credit to an ad click; nearest everyday English: sales you did not pay for with advertising. Distinct from "organic ranking", already in the glossary
- Ordered Product Sales — the exact column name in Seller Central's Business Reports carrying total sales at the time of order; kept in English because the reader must match it visually on screen
- cost stack — the list of per-unit costs subtracted from the selling price to reach contribution before advertising; nearest everyday English: your list of costs per unit
